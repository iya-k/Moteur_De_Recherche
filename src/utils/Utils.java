...
public class Utils 
{
	    ...
	    public static final String SUFFIXES_iqU = "iqU";
	    public static final String SUFFIXE_ABL = "abl";
	    public static final String SUFFIXE_ABIL = "abil";
	    public static final String SUFFIXES_EUS = "eus";
	    public static final String SUFFIXES_EUX = "eux";
	    ...
	    public static final ArrayList<String> SUFFIXES_ISMES = new ArrayList<String>() {
	        {
	            add("istes");
	            add("iqUes");
	            add("ances");
	    ...
	    public static final ArrayList<String> SUFFIXES_CONJ_I = new ArrayList<String>() {
	        {
	    ...
	    public static final ArrayList<String> SUFFIXES_CONJ_E = new ArrayList<String>() {
	        {
	    ...
	    public static final ArrayList<String> SUFFIXES_CONJ_A = new ArrayList<String>() {
	        {
	    ...
	    public static final ArrayList<String> SUFFIXES_AT = new ArrayList<String>() {
	        {
	            add("atrices");
	            add("atrice");
	            add("ations");
	    ...
	    public static final ArrayList<String> SUFFIXES_IT = new ArrayList<String>() {
	        {
	            add("ités");
	            add("ité");
	        }
	    ...
	    public static final ArrayList<String> SUFFIXES_IV = new ArrayList<String>() {
	        {
	            add("ives");
	            add("ive");
	            add("if");
	    ...
	    public static final ArrayList<String> SUFFIXES_LOG = new ArrayList<String>() {
	        {
	            add("logies");
	            add("logie");
	        }
	    ...
	    public static final ArrayList<String> SUFFIXES_TIONS = new ArrayList<String>() {
	        {
	            add("utions");
	            add("usions");
	            add("usion");
	    ...
	    public static final ArrayList<String> SUFFIXES_IER = new ArrayList<String>() {
	        {
	            add("Ière");
	            add("ière");
	            add("ier");
	    ...
	    public static final ArrayList<String> SUFFIXES_ENCE = new ArrayList<String>() {
	        {
	            add("ences");
	            add("ence");
	        }
	    ...
	    public static final ArrayList<String> SUFFIXES_EMENT = new ArrayList<String>() {
	        {
	            add("ements");
	            add("ement");
	        }
